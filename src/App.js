...
function App() {
  return (
    <div>
      ...
      {/* Hero Section */}
      <section className="hero" style={{ backgroundImage: 'url("")', backgroundSize: 'cover', backgroundPosition: 'center', padding: '100px 0', textAlign: 'center', color: '#fff' }}>
      ...
      {/* Contact Section */}
      <section id="contact" className="contact" style={{ padding: '60px 0', textAlign: 'center' }}>
        <Container maxWidth="sm">
          <ContactForm />
        </Container>
      </section>
